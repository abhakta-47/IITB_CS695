...
{
    int current_vcpu = 1, ret = 0, buffer = -1;
    ...
    while (!vm1_done || !vm2_done)
    {
        ...
        case KVM_EXIT_IO:
            ...
            {
                buffer = *(int *)((char *)(vm->vcpus->kvm_run) + vm->vcpus->kvm_run->io.data_offset);
            ...
            else if (vm->vcpus->kvm_run->io.direction == KVM_EXIT_IO_IN && vm->vcpus->kvm_run->io.port == 0x11)
            {
                ...
                *(int *)((char *)(vm->vcpus->kvm_run) + vm->vcpus->kvm_run->io.data_offset) = buffer;
                current_vcpu = 2;
            }
